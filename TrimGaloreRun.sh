...
find   /home/users/medwards38/TB/RNAseq/data/Raw_data  -name *R1.fastq.gz | parallel  --jobs 12 trim_galore --clip_R1 15 --clip_R2 15 --three_prime_clip_R1 2 --three_prime_clip_R2 2 -q 30 -length 50 --paired --trim1 --fastqc -o /home/users/medwards38/TB/RNAseq/data/Trimmed {} {=s/.R1./.R2./=}
