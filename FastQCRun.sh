...
find  /home/users/medwards38/TB/RNAseq/data/NewRun//Raw_data  -name *.fastq.gz | parallel --jobs 12 'fastqc  -o /home/users/medwards38/TB/RNAseq/data/NewRun//FastQC -f fastq --extract {}'
